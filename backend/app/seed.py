...
_DEMO_DRAFTS: list[tuple] = [
    ...
    (
        "grading",
        "คำตอบนักเรียน (ตัวอย่าง): สังคมศึกษา — แม่น้ำเจ้าพระยาไหลลงอ่าวไทย",
    ...
    # --- grading: approved (worksheet / certificate sources) ---
    (
        "grading",
    ...
    (
        "grading",
        "คำตอบนักเรียน (ตัวอย่าง): พืชหายใจด้วยปากใบ (stomata) บริเวณใต้ใบ",
    ...
    (
        ...
        "approved", [], "demo-teacher", 1.8, 1,
    ),
    # --- grading: rejected / quarantined ---
    (
        "grading",
    ...
    # --- lesson-plan: approved (lesson-record source) ---
    (
        "lesson-plan",
    ...
    # --- reporting: approved (official-letter / certificate sources) ---
    (
        "reporting",
    ...
    (
        ...
        "approved", [], "demo-teacher", 1.6, 1,
    ),
    # --- reporting: rejected / quarantined ---
    (
        "reporting",
